...
| Conversation owner   | [conversationOwner.ts](../../apps/web/src/store/conversationOwner.ts) resolves and validates ordinary Question ownership and serializes owner lifecycle patches                                                                                                                                                                                                  |
